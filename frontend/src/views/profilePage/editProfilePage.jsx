    ...
    return (
        <React.Fragment>
            ...
            <div className="tw-w-full tw-overflow-y-hidden dark:tw-bg-[rgb(18,18,18)]" >
                <div className=' tw-flex tw-w-full tw-justify-center tw-items-center tw-mt-[80px] dark:tw-border-t tw-border-solid dark:tw-border-[#303030]'>
                    <div className=' tw-justify-center tw-items-center tw-w-[20%] tw-border-r dark:tw-border-[#303030] tw-border-solid tw-border-gray-300 tw-hidden lg:tw-flex'>
                        <Card className="tw-h-[calc(100vh-2rem)] tw-w-full tw-max-w-[20rem] tw-p-4 tw-shadow-none dark:tw-bg-[rgb(18,18,18)] tw-bg-[#ffffff]">
                    ...
                    <div className='tw-flex tw-justify-start tw-items-start tw-w-[100%] tw-overflow-y-visible tw-flex-col tw-px-[10px] sm:tw-px-[100px] lg:tw-w-[80%]' style={{ fontFamily: 'Smack' }}>
